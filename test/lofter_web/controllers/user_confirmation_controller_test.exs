defmodule LofterWeb.UserConfirmationControllerTest do
  ...
  describe "GET /user/confirm" do
    test "renders the resend confirmation page", %{conn: conn} do
      ...
      assert response =~ "data-test=\"resend-user-confirmation-page-header\""
    end
  end
  ...
  describe "GET /user/confirm/:token" do
    test "renders the confirmation page", %{conn: conn} do
      ...
      response = html_response(conn, 200)
      assert response =~ "data-test=\"user-confirmation-page-header\""
