defmodule LofterWeb.UserAuthTest do
  use LofterWeb.ConnCase, async: true

  alias Lofter.Accounts
  alias LofterWeb.UserAuth
  import Lofter.AccountsFixtures

  @remember_me_cookie "_lofter_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, LofterWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      LofterWeb.Endpoint.subscribe(live_socket_id)
