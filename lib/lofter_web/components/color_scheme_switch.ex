defmodule LofterWeb.Components.ColorSchemeSwitch do
  ...
  def color_scheme_switch(assigns) do
    ...
    <button
      ...
      class="ring-1 ring-gray-800 text-black dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-1 focus:ring-gray-200 dark:focus:ring-gray-800 rounded-full text-sm p-2.5"
    >
      <svg
